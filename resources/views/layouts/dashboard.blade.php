...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('dashboard/assets/compiled/png/5.png') }}" type="image/x-icon">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="#"><img src="{{ asset('dashboard/assets/compiled/svg/Logo MADIN.png') }}"
                                ...
                                <button type="submit"
                                    ...
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img"
                                            ...
                                            viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M14.08 15.59L16.67 13H7v-2h9.67l-2.59-2.59L15.5 7l5 5l-5 5M3 19V5a2 2 0 0 1 2-2h6v2H5v14h6v2H5a2 2 0 0 1-2-2Z">
                                            </path>
                                        </svg>
                                    </span>
                                    {{-- <span>Logout</span> --}}
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('dash.galeri') }}" class='sidebar-link'>
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ route('dash.artikel') }}" class='sidebar-link'>
                        ...
                        <li class="sidebar-item ">
                            ...
                            <a href="{{ route('dash.komentar') }}" class="sidebar-link">
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ route('dash.pengumuman') }}" class='sidebar-link'>
                                <i class="bi bi-megaphone"></i>
                                <span>Pengumuman</span>
                            </a>
                        </li>
                        <li class="sidebar-item ">
                            <a href="{{ route('dash.kegiatan-alumni') }}" class='sidebar-link'>
                                <i class="bi bi-gem"></i>
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ route('dash.profil-website') }}" class='sidebar-link'>
                        ...
                        @if (auth()->user()->role == 'Admin')
                            <li class="sidebar-item">
                                <a href="{{ route('dash.user') }}" class="sidebar-link">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2025 &copy; Madrasah Diniyah Al-Hidayah</p>
                    </div>

                    <div class="float-end">
                        <p>Developed by <span class="text-primary">Muhammad Ichwan</span></p>
                    </div>
                </div>
            </footer>
        </div>
